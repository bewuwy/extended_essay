...
\begin{document}
    ...
    \section{Finding the road for a rolling square}
        ...
        Given that the angle we are looking for is $90\degree$, $\tan\theta$ should be undefined ($\cos90\degree = 0$), thus:
        \begin{align}
            1 + m_1 m_2 = 0 \\
            m_1 m_2 = -1
        \end{align}
    ...
    \section{Finding the road for a rounded square}
        ...
        This way, we find $y$ in terms of angle $\theta$. This parametrization will be easier for this part of the road. Hence, $x$ should also be found in terms of $\theta$.

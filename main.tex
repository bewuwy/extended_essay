...
\begin{document}
    ...
    \section{Rounding the square}
        ...
        This equation can be derived using some trigonometry. Let $O$ be the origin point $(0,0)$, $A$ be the centre of the circle - $A =(1-b,b-1)$ and $B$ be an arbitrary point on the rounded corner. Then, the $r$ we are looking for is the length of $OB$. The situation can be seen in Figure~\ref{fig:corner_cos_rule}.
        ...
        By making the base polar axis to be at angle $-\frac{\pi}{4}$ to the x-axis, the angle $\alpha = \theta + \frac{\pi}{4}$. 
    ...
    \section{Finding the road for a rounded square}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{images/masterplan_overlayed.png}
    ...
    \section{Finding roads for different polygonal wheels}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{images/tirangle_road_with.png}

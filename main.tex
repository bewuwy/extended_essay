...
\begin{document}
    ...
    \section{Introduction}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.75\linewidth]{images/photo_cranking.png}
    ...
    \section{Euler's approximation Python code}\label{app:euler_python}

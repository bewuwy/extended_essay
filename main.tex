...
\begin{document}
    ...
    \section{Rounding the square}
        ...
        \begin{align}
            ...
            I_1 &= \frac{3}{4} \cdot \frac{\sin(\theta) + \cos(\theta)}{\sqrt{2}} \Hquad
        \end{align}

        However, the $I_2$ is way trickier than the $I_1$ and cannot be solved using simple methods learned during the IB mathematics, as it is an elliptic integral of the second kind. Therefore, it will be instead solved numerically using the Euler's method. 
